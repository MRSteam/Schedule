...
- (void)viewDidLoad
{
    ...
    UIBarButtonItem *toolBarButtonPress = [[UIBarButtonItem alloc] initWithTitle:@"Cafe" style:UIBarButtonItemStyleDone target:self action:@selector(toolBarButtonPress:)];
    self.navigationItem.rightBarButtonItem = toolBarButtonPress;
